    ...
    def _collect_outputs(self, loader):
        ...
        with torch.no_grad():
            ...
            for x, y in loader:
                ...
                # grab matching filenames
                batch_samples = loader.dataset.samples[start_idx:start_idx + batch_size]
                batch_files = [os.path.basename(p[0]) for p in batch_samples]
                files_list.extend(batch_files)
